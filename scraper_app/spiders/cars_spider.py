...
from scrapy.contrib.linkextractors.sgml import SgmlLinkExtract
...
class CarsNationalSpider(CrawlSpider):
    ...
    allowed_domains = ["cars.brick7.co.za/price"]
    start_urls = ["http://www.cars.brick7.co.za/price/honda"]
	
    rules = (
	Rule(SgmlLinkExtractor(allow=(), restrict_xpaths=('//div/div[@class="cat_bg"]/div[@id="price_list"]/ul[@class="price_list_col2"]/li[@class="pb2"]/ul/li[@class="bold"]/a',)), callback="parse_items", follow= True),
    )
    ...
    def parse_items(self, response):
        ...
        # iterate over deals
        for CarsNational in selector.select(self.cars_list_xpath):
